...
<style>
	...
	.staff3-list-labels-row div:hover {
		cursor: pointer;
	}
	.staff3-list-labels-row div:hover a img {
		background-color: #007def;
	}
	.staff3-list-labels-row div:hover a p {
		color: #007def;
	}
	.staff3-list-row {
		display: block;
	...
	.staff3-list-row:nth-child(even){
	...
	{ padding-right: 8px; }
	.staff3-list-labels-row a, .staff3-list-labels-row span { border: solid 0px #ffffff !important; }
	.staff3-list-row:last-child { border-bottom: solid #cacaca 1px; }
	...
	.staff3-list-row .column-1, .staff3-list-labels-row .column-1 {
		display: block;
		text-align: center !important;
		width: 100%;
	}
	.staff3-list-labbels-row .column-1 {
		margin-bottom: 10px;
	}
	.staff3-list-row .column-2,.staff3-list-row .column-3,.staff3-list-row .column-4,.staff3-list-row .column-5,
	.staff3-list-labels-row .column-2,.staff3-list-labels-row .column-3,.staff3-list-labels-row .column-4,.staff3-list-labels-row .column-5 {
	width: 25%;
	}
...
$(document).ready(function(){
	...
	var pageItems3 = $('.staff3-list-row').length;
